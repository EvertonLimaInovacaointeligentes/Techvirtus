...
namespace TechVirtusProvaEverton.Migrations
{
    ...
    [Migration("20170821015359_CriaEmpresaContratadaContratanteTransasao")]
    partial class CriaEmpresaContratadaContratanteTransasao
    {
            ...
            modelBuilder.Entity("TechVirtusProvaEverton.Models.EmpresaContratada", b =>
                {
                    ...
                    b.HasOne("TechVirtusProvaEverton.Models.Transacao")
                        .WithOne()
                        .HasForeignKey("TechVirtusProvaEverton.Models.EmpresaContratada", "TransacaoId");
                });
